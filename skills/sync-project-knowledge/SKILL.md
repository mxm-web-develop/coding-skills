...
1. Read current machine state, events, active objects, releases, evidence, and archive index.
...
4. Move superseded snapshots to `.ai-flow/archive/<type>/<version>/` and remove them from active indexes.
...
8. Verify that `docs/board/` reflects the machine state and contains no untracked claims.
9. Report what changed, what was archived, and any unresolved documentation conflict.
