...
4. **Decision-rights gate** — Is a real user decision needed now? If so, explain the options and their consequences. If not, state the result or next action and continue authorized work. Status reports, routine fixes and informative updates do not require a manufactured choice or confirmation.
